// src/app/(site)/business-services/page.tsx
...
export const metadata = {
  ...
  description: "Enterprise travel management, business invitations, and expo delegation assistance.",
};

export default function BusinessServicesPage() {
  const corporateServices = [
    { title: "Business Invitation Sourcing", desc: "Procurement and verification of formal business invitations required for cross-border commercial visas.", icon: FileSignature },
    { title: "Conference & Expo Delegation", desc: "Comprehensive registration and visa profiling for teams attending international summits.", icon: Presentation },
    { title: "Enterprise Travel Management", desc: "End-to-end logistics including VIP flight booking, executive transfers, and luxury accommodation.", icon: Building2 },
    { title: "Document Attestation", desc: "Legalization and formal attestation routing for corporate and personal credentials.", icon: Briefcase },
  ];
    ...
    <div className="pt-32 pb-24">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-24">
        {corporateServices.map((svc, i) => {
          const Icon = svc.icon;
          return (
            <div key={i} className="p-8 rounded-2xl bg-gradient-to-b from-navy-900 to-navy-950 border border-navy-800">
