...
export default async function StaticCountryDetailPage({
  params,
}: {
  ...
  const country = {
    ...
    overview:
      "Comprehensive visa and migration consultancy. Specialized guidance for visits, business, and study pathways with elite verification standards.",
    visaServices: [
      {
        id: "1",
        category: "VISIT_VISA",
        ...
        description:
          "End-to-end documentation auditing, itinerary structuring, and application filing assistance.",
        requirements: [
          "Valid Passport (6+ Months)",
          "Financial Records (6 Months)",
          "Ties to Home Country Verification",
          "Cover Letter & Travel Deck",
        ],
      },
      {
        id: "2",
        ...
        description:
          "Academic application alignment, financial sponsorship structuring, and permit processing support.",
        requirements: [
          "Acceptance Letter (LOA/CAS/I-20)",
    ...
    faqs: [
      {
        ...
        answer:
          "Processing periods are governed directly by the respective consulate authorities. We ensure accurate filing to avoid preventable delays.",
      },
      {
        id: "f2",
        question: "Are visa approvals guaranteed?",
        answer:
          "No consultancy can ethically guarantee visa issuance. ELITRAX offers high-tier regulatory compliance, application structuring, and risk reduction.",
      },
    ],
  };
        ...
        <section className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {country.visaServices.map((svc) => (
              <div
                key={svc.id}
                className="p-8 rounded-2xl bg-navy-900/60 border border-navy-800 space-y-6 hover:border-gold-500/30 transition"
              >
                <div>
                ...
                <div>
                  <h4 className="text-xs uppercase tracking-wider font-semibold text-gray-400 mb-3 flex items-center gap-1.5">
                    <FileText className="w-4 h-4 text-gold-400" /> Key Required
                    Documentation
                  </h4>
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {country.faqs.map((faq) => (
              <div
                key={faq.id}
                className="p-6 rounded-xl bg-navy-900/40 border border-navy-800 space-y-2"
              >
