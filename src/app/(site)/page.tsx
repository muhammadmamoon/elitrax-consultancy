...
import { ShieldCheck, Compass, Award, Users, ChevronRight, FileText, Globe2, Briefcase } from "lucide-react";
    ...
    <div className="flex flex-col gap-24 pb-24">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-24 pb-16 px-6 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center space-y-8 relative z-10">
          ...
          <h1 className="text-4xl md:text-7xl font-extrabold text-white tracking-tight leading-tight">
            Your Journey. <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold-300 via-gold-400 to-gold-600">Our Expertise.</span>
          </h1>
      ...
      <section className="max-w-7xl mx-auto px-6 w-full">
        <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
          ...
          <p className="text-3xl font-bold text-white">Why Discerning Travelers Choose ELITRAX</p>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 w-full space-y-12">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-navy-800 pb-6">
          <div>
            ...
            <h2 className="text-3xl font-bold text-white mt-1">Core Service Disciplines</h2>
          </div>
          <Link href="/services" className="text-gold-400 hover:text-gold-300 text-sm font-semibold flex items-center gap-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-8 rounded-2xl bg-gradient-to-b from-navy-900 to-navy-950 border border-gold-500/20 relative overflow-hidden flex flex-col justify-between h-96">
            <div>
              <span className="text-xs font-semibold uppercase text-gold-400">Vertical I</span>
            ...
            <Link href="/umrah" className="inline-flex items-center gap-2 text-gold-400 text-sm font-bold mt-6">
          ...
          <div className="p-8 rounded-2xl bg-gradient-to-b from-navy-900 to-navy-950 border border-gold-500/20 relative overflow-hidden flex flex-col justify-between h-96">
            <div>
              <span className="text-xs font-semibold uppercase text-gold-400">Vertical II</span>
            ...
            <Link href="/countries" className="inline-flex items-center gap-2 text-gold-400 text-sm font-bold mt-6">
          ...
          <div className="p-8 rounded-2xl bg-gradient-to-b from-navy-900 to-navy-950 border border-gold-500/20 relative overflow-hidden flex flex-col justify-between h-96">
            <div>
              <span className="text-xs font-semibold uppercase text-gold-400">Vertical III</span>
            ...
            <Link href="/business-services" className="inline-flex items-center gap-2 text-gold-400 text-sm font-bold mt-6">
      ...
      <section className="max-w-5xl mx-auto px-6 w-full">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl font-bold text-white mt-2">Initiate Your Consultation</h2>
        </div>
        <ContactForm />
      </section>
    </div>
