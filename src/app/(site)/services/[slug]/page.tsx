...
export default async function StaticServiceDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const service = {
    ...
    overview: "We provide high-tier regulatory compliance and application structuring. Our consultants audit your profile, extract necessary documentation, and build a risk-averse pathway for your global mobility goals.",
    keyBenefits: [
    ...
    processSteps: [
      {
        ...
        description: "A comprehensive review of your current standing, financial solvency, and travel history."
      },
      {
        title: "Strategy & Documentation",
        description: "Gathering and structuring all mandatory and supporting documents to align with consulate requirements."
      },
      {
        title: "Application Filing",
        description: "Precision data entry and submission of your file to the respective embassy or high commission."
      },
      {
        title: "Interview Prep & Dispatch",
        description: "Mock interview sessions (if required) and final application dispatch tracking."
      }
    ]
  };
  ...
  return (
    <div className="pt-24 pb-24">
      ...
      <div className="relative h-[400px] w-full flex items-center justify-center overflow-hidden border-b border-gold-500/20">
        <Image src={service.heroImage} alt={service.title} fill priority className="object-cover brightness-50" />
        <div className="absolute inset-0 bg-navy-950/70" />
        
        <div className="relative z-10 text-center max-w-4xl px-6 space-y-4 mt-12">
          <Link href="/services" className="inline-flex items-center gap-2 text-xs font-semibold text-gold-400 hover:text-gold-300 uppercase tracking-widest mb-2 transition">
          ...
          <section>
            ...
            <div className="space-y-6">
              {service.processSteps.map((step, idx) => (
                <div key={idx} className="flex gap-4 p-6 rounded-xl bg-navy-900/40 border border-navy-800">
        ...
        <div className="space-y-8">
          ...
          <div className="p-8 rounded-2xl bg-gradient-to-br from-gold-600 to-gold-400 text-navy-950 shadow-[0_0_30px_rgba(212,175,55,0.15)] relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-navy-900 text-sm mb-6 font-medium">Connect with our senior analysts to evaluate your specific case.</p>
